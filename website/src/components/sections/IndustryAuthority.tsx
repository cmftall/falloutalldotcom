        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20 rounded-2xl p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {t('industryAuthority.thoughtLeadership.content', { returnObjects: true }).map((content: any, index: number) => (
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <ul className="space-y-1">
                          {content.keyInsights.map((insight: string, insightIndex: number) => (
                      ...
                      <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                        <div className="flex items-center justify-between">
                          <div className="flex space-x-2">
                            {content.targetAudience.map((audience: string, audienceIndex: number) => (
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {t('industryAuthority.professionalRecognition.achievements', { returnObjects: true }).map((achievement: string, index: number) => (
                <motion.div
                  key={index}
          ...
          >
            ...
            <div className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-950/20 dark:to-blue-950/20 rounded-2xl p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {t('industryAuthority.industryInsights.insights', { returnObjects: true }).map((insight: string, index: number) => (
                  <motion.div
                    key={index}
